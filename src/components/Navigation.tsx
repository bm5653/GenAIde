...
export const Navigation: React.FC<NavigationProps> = ({ activeTab, onTabChange }) => {
  ...
  return (
    <nav className="sticky top-0 z-40 bg-[#2E1065] text-white shadow-lg border-b border-purple-800/90">
      ...
      {/* ========================================================= */}
      {/* MOBILE BOTTOM FLOATING QUICK-DOCK (Easy Thumb Navigation)  */}
      {/* Specifically gives 1-tap thumb access to key features     */}
      {/* ========================================================= */}
      <div className="sm:hidden fixed bottom-0 left-0 right-0 z-50 bg-[#250d53]/95 backdrop-blur-md border-t border-purple-700/80 px-2 py-1 shadow-2xl flex items-center justify-around">
        <button
          onClick={() => handleSelect('home')}
          className={`flex flex-col items-center gap-0.5 p-1.5 rounded-lg text-[10px] font-medium transition-colors ${
            activeTab === 'home' ? 'text-amber-300 font-bold' : 'text-purple-300 hover:text-white'
          }`}
        >
        ...
        <button
          ...
          className={`flex flex-col items-center gap-0.5 p-1.5 rounded-lg text-[10px] font-medium transition-colors ${
            activeTab === 'practice' ? 'text-amber-300 font-bold' : 'text-purple-300 hover:text-white'
          }`}
        >
        ...
        <button
          ...
          className={`flex flex-col items-center gap-0.5 p-1.5 rounded-lg text-[10px] font-medium transition-colors relative ${
            activeTab === 'exit-ticket' ? 'text-amber-300 font-bold' : 'text-purple-300 hover:text-white'
          }`}
        >
        ...
        <button
          onClick={() => handleSelect('ai-help')}
          className={`flex flex-col items-center gap-0.5 p-1.5 rounded-lg text-[10px] font-medium transition-colors relative ${
            activeTab === 'ai-help' ? 'text-emerald-300 font-bold' : 'text-purple-300 hover:text-white'
          }`}
        >
        ...
        <button
          ...
          className={`flex flex-col items-center gap-0.5 p-1.5 rounded-lg text-[10px] font-medium transition-colors ${
            activeTab === 'notes' ? 'text-cyan-300 font-bold' : 'text-purple-300 hover:text-white'
          }`}
        >
        ...
        <button
          ...
          className={`flex flex-col items-center gap-0.5 p-1.5 rounded-lg text-[10px] font-medium transition-colors ${
            activeTab === 'progress' ? 'text-rose-300 font-bold' : 'text-purple-300 hover:text-white'
          }`}
        >
